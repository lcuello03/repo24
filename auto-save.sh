#!/bin/bash
AZURE_STORAGE_ACCOUNT_NAME="bdsbkpdev"
AZURE_CONTAINER_NAME="bds"
AZURE_STORAGE_SAS_READ_TOKEN="sp=r&st=2022-08-30T22:01:03Z&se=2032-12-31T06:01:03Z&sv=2021-06-08&sr=c&sig=Zhrd5V%2FspQEilgtR7nvO5YyoSWpg8BakmNVu%2B12QbCM%3D"
AZURE_STORAGE_SAS_WRITE_TOKEN="sp=racwl&st=2022-08-30T22:01:03Z&se=2032-12-31T06:01:03Z&sv=2021-06-08&sr=c&sig=eRAxoYyOpzGtc3tvmwBTDFubIfNANytxkCffgeIuKBc%3D"
...
git_backup ()
{
    ...
    git checkout -b "${branch_name}Demo" || return "$return_value"
